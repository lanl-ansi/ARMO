...
ExternalProject_Add(gravity
    DOWNLOAD_DIR ${THIRDPARTY_INSTALL_PATH}
    DOWNLOAD_COMMAND export HTTPS_PROXY=$ENV{HTTPS_PROXY} && git clone -b Align --single-branch ${GRAVITY_DOWNLOAD_URL} && cd ./Gravity && mkdir build && cd build && cmake .. -DGurobi=${Gurobi} -DIpopt=${Ipopt} && make gravity
    URL ${MP_DOWNLOAD_URL}
