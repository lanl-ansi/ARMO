...
if(APPLE)
set(LASLIB_LIBRARY ${THIRDPARTY_INSTALL_PATH}/Install/LASTOOLS/LASlib/lib/liblas.a)
elseif(UNIX)
set(LASLIB_LIBRARY ${THIRDPARTY_INSTALL_PATH}/Install/LASTOOLS/LASlib/lib/liblas.so)
endif(APPLE)
