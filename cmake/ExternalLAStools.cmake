...
ExternalProject_Add(LASTOOLS
    DOWNLOAD_DIR ${THIRDPARTY_INSTALL_PATH}
    DOWNLOAD_COMMAND export HTTPS_PROXY=$ENV{HTTPS_PROXY} && test -d LAStools: test -d LAStools && echo "LAStools exist" || git clone ${LASTOOLS_DOWNLOAD_URL} && cd ./LAStools && git checkout tags/v2.0.0 && make
    URL ${MP_DOWNLOAD_URL}
